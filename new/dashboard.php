            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Project details <a class="pull-right btn btn-primary" href="addproject.php">Add new Project</a>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="project.php?projectid=<?php echo $row['id'] ?>"><?php echo $row['title'] ?></a>
                                    </td>
                                    <td>
